...
import { connectMongoDB, disconnectDB } from "../../config/connectMongoDB";
import User from "../../models/user/model";
import { PUT } from "../../app/api/user/[username]/update/route";
import { defaultUser } from "../support-data";
import * as AuthLib from "../../lib/authentication"
import * as CheckExistLib from "../../lib/checkExist"
import { POST as POSTPassword } from "../../app/api/user/[username]/update/password/route";
import { POST as POSTPin} from "../../app/api/user/[username]/update/pin/route";
import bcrypt from 'bcrypt';

// Mock the dependencies
jest.mock("config/connectMongoDB");
